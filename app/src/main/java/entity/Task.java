...
public class Task {
    ...
    public boolean equals(Object obj) {
        ...
        {
            Task temp=(Task) obj;
            if(temp.getTask_id()==getTask_id()
                    && temp.getProject_id()==getProject_id()
                    && temp.isCompleted()==isCompleted()
                    && temp.getTask_start_date().equals(getTask_start_date())
                    && temp.getTask_end_date().equals(getTask_end_date())
                    && temp.getTask_summary().equals(getTask_summary())
                    && temp.getDone_total_hours()==getDone_total_hours()
                    )
            {
                return true;
            }
